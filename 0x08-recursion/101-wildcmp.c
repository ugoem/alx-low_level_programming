...
{
	/**
	 * this will be the sum of the return values
	 */
	int sum = 0;
	 ...
	 * if the end of s1 is reached, return 1
	...
	/**
	 * if the end of s1 or s2 strings are reached,
	 * return 0
	 */
	if (*s1 == '\0' || *s2 == '\0')
		return (0);
...
{
	/**
	 * if the end of s1 is reached, return 0
